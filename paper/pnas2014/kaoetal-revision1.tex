...
\end{equation}
%
$C(u)$ is the psychological cost of an utterance, potentially determined by factors such as availability, frequency, and complexity. The exponentiation results from using a Luce-choice rule, which is used extensively to model human decision-making\cite{sutton1998reinforcement}.
