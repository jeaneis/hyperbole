...
\caption{Comparing models with different communicative goals to human interpretations of the utterance ``The electric kettle cost 1,000 dollars." A model that considers both affect and precision goals (full model) most closely matches human data.} 
\label{model_effects}
\end{minipage}\hfill
\end{figure}
