...
Despite having highly standard literal meanings, numbers are often used non-literally in everyday language. Results from our behavioral experiment show that people are aware of the flexible nature of number meanings and often interpret number expressions in imprecise or non-literal ways. Building upon recent work on models of pragmatic reasoning, our computational model shows that rational recursive reasoning between speaker and listener can capture the effects of pragmatic halo and hyperbole that we observed in the behavioral experiment. Furthermore, our model introduces an ``affect" dimension to language interpretation, such that hyperbolic utterances efficiently convey information regarding the speaker's opinion and affective state. However, the subtext of such non-literal utterances often goes beyond the binary valence information that our model captures. Future work should explore additional ways in which the listener infers rich subtext from a speaker's utterances, such as whether the speaker's goal is to communicate a fact about the world or her subjective opinion, in addition to other kinds of rich social information. We argue that formal models of recursive social reasoning such as the one we describe here can capture interesting phenomenon in pragmatic interpretation, as well as contribute to our understanding of communication and non-literal language understanding.
%\begin{figure}
